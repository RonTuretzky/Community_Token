...
describe("Token contract", function () {
  ...
  beforeEach(async function () {
    ...
    Token = await ethers.getContractFactory("CommunityToken_ERC20");
  ...
  describe("Transactions", function () {
    ...
    it ("Full usecase", async function(){
      ...
      await hardhatToken.connect(owner).add_event(4,addr3.address,true);
      await hardhatToken.connect(addr4).event_payment(4);
      const addr2Balance2 = await hardhatToken.balanceOf(
        addr4.address
      );
      expect(addr2Balance2).to.equal(0);
